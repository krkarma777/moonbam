...
//@Configuration
//@EnableWebSecurity
//public class SecurityConfig_구 { // WebSecurityConfigurerAdapter는 securityFilterChain과 동시 사용 불가
//
//	@Autowired
...
//
//	public SecurityConfig_구(AuthenticationConfiguration authenticationConfiguration, OAuthService oAuthService, JWTUtil jwtUtil) {
