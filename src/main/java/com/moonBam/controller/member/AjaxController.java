...
public class AjaxController {
	...
	public String AjaxCheckIDPW(String userId, String password) throws NoSuchAlgorithmException, UnsupportedEncodingException, GeneralSecurityException {
		String realPassword = sc.encrypt(password);
		boolean canLogin = lServ.loginPossible(userId, realPassword);
