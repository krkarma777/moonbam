				...
				<div style="height: 910px; width: 1200px; margin: auto;">
					...
					<div style="">
						...
						<button type="button" class="btn"
							style="background-color: #ff416c; color: white; margin-left: auto;"
							id="myChatList">
							<b>내방</b>
						</button>
						<!-- 개설 버튼 -->
					...
					<table style="margin-top: 5px; width: 1200px; height: 795px">
						...
						<tr style="width: 1200px; height: 265px;">
							...
							%>
							<td id="<%=count%>"
								style="width: 300px; height: 265px; float: left">
								<div class="border" style="width: 300px; height: 265px;">
									<div class="border-bottom"
										style="height: 40px; width: 299px; background-color: #ffb2c4; align-content: center;">
										<a href="chatRoom?chatNum=<%=chatNum%>"
											style="color: black; font-size: 15px;">[<%=category%>] <%=roomTitle%></a>
									</div>
									<div class="border-top" style="height: 225px; width: 299px;">
										...
										<div
											style="width: 100%; height: 49px; font-size: 15px; padding-left: 2px; padding-right: 5px; position: relative;">
											<div style="float: left;"><%=addr1%></div>
											<div
												style="position: absolute; right: 0; bottom: 0; margin-right: 2px;"><%=currentNow%>/<%=amount%></div>
										</div>
									</div>
								</div>
							</td>
