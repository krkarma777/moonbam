                    ...
                    <div class="card-body">
                        <form action="updateProfile" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="secretCode" name="secretCode" value="${loginUser.secretCode}" disabled>
                            </div>
                            <div class="mb-3 form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="googleConnected" name="googleConnected" ${loginUser.googleConnected == 1 ? 'checked' : ''} disabled>
                                <label class="form-check-label" for="googleConnected">구글 연동됨</label>
                            </div>
                            <div class="mb-3 form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="naverConnected" name="naverConnected" ${loginUser.naverConnected == 1 ? 'checked' : ''} disabled>
                                <label class="form-check-label" for="naverConnected">네이버 연동됨</label>
                            </div>
                            <div class="mb-3 form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="kakaoConnected" name="kakaoConnected" ${loginUser.kakaoConnected == 1 ? 'checked' : ''} disabled>
