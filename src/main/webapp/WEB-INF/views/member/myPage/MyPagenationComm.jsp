...
// 1. 첫 페이지로 바로 이동
    if (curPage == 1)
        ...
        out.print("<li class='page-item'><a class='page-link' href='comment?curPage=1'>처음</a></li>");

// 2. 이전 페이지로 이동
    if (curPage == 1)
        out.print("<li class='page-item'><a class='page-link'>&lt;</a></li>");
    else
        out.print("<li class='page-item'><a class='page-link' href='comment?curPage=" + (curPage - 1) + "'>&lt;</a></li>");
...
// 3. 페이지번호들
    for (int i = startPage; i < endPage; i++) { // 마지막페이지번호는 표시 안 하고, for 루프 밑에서 표시( 공백 표시 때문에... )
        ...
        if (curPage == i)
            ...
            out.print("<li class='page-item'><a class='page-link' href='comment?curPage=" + i + "'>" + i + "</a></li>");

    }
    if (curPage == endPage)
        out.print("<li class='page-item'><a class='page-link'>" + endPage + "</a></li>");
    else
        out.print("<li class='page-item'><a class='page-link'  href='comment?curPage=" + endPage + "'>" + endPage + "</a></li>");
...
// 1. 마지막 페이지로 바로 이동
    if (curPage == totalNum)
        ...
        out.print("<li class='page-item'><a class='page-link' href='comment?curPage=" + totalNum + "'>마지막</a></li>");
    out.print("</ul>");
